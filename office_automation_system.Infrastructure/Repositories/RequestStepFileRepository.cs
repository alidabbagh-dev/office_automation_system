...
{
    public class RequestStepFileRepository : Repository<RequestStepFile>, IRequestStepFileRepository
    {
        public RequestStepFileRepository(ApplicationDbContext context) : base(context) { }
