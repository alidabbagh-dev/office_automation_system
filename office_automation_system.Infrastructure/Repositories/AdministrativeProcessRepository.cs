...
{
    public class AdministrativeProcessRepository : Repository<AdministrativeProcess>, IAdministrativeProcessRepository
    {
        public AdministrativeProcessRepository(ApplicationDbContext context) : base(context) { }
