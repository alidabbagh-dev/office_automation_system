...
{
    public class ProcessApprovalStepRepository : Repository<ProcessApprovalStep>, IProcessApprovalStepRepository
    {
        public ProcessApprovalStepRepository(ApplicationDbContext context) : base(context) { }
